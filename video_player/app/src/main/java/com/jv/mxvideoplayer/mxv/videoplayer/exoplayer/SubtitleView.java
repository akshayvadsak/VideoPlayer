 ...
 */
package com.jv.mxvideoplayer.mxv.videoplayer.exoplayer;
...
public final class SubtitleView extends View implements TextRenderer.Output {
    ...
    public SubtitleView(Context context, AttributeSet attrs) {
        ...
        //style = new CaptionStyleCompat(Color.WHITE, Color.TRANSPARENT, Color.TRANSPARENT, CaptionStyleCompat.EDGE_TYPE_NONE, Color.WHITE, null);
    ...
    public void setUserDefaultStyle() {
        setStyle(Util.SDK_INT >= 19 && !isInEditMode() ? getUserCaptionStyleV19() : CaptionStyleCompat.DEFAULT);
    }
