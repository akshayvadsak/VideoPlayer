...
public class RateThisApp {
    ...
    public static void showExitDialog(final Activity context, final AlertDialog.Builder builder) {

        int yesButtonID = R.string.exit_dialog_yes;
        int noButtonID =  R.string.exit_dialog_no;
        ...
        builder.setPositiveButton(yesButtonID, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                context.finish();
        ...
        builder.setNegativeButton(noButtonID, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
    ...
    public static class Config {
        ...
        private int mCancelMode = CANCEL_MODE_NONE;
